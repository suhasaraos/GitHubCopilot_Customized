          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <svg
                ...
                className={`h-5 w-5 ${darkMode ? 'text-light hover:text-primary' : 'text-gray-700 hover:text-primary'} transition-colors`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-primary text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center leading-none">
